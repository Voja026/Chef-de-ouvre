...
conn = connect_db("plants", "md", "postgres", "localhost", "5432")
cursor = conn.cursor()
...
def insert_cap():
    try:
        data = csv.reader(open('/home/md/Téléchargements/energyredux.csv'),delimiter=',')
        for row in data:
...
def insert_own():
    try:
        data = csv.reader(open('/home/md/Téléchargements/owner.csv'),delimiter=',')
        for row in data:
...
def insert_fuel():
    try:
        data = csv.reader(open('/home/md/Téléchargements/fuel.csv'),delimiter=',')
        for row in data:
...
def insert_loc():
    try:
        data = csv.reader(open('/home/md/Téléchargements/country.csv'),delimiter=',')
        for row in data:
...
def insert_geo(latitude, longitude):
    try:
        data = csv.reader(open('/home/md/Téléchargements/geo.csv'),delimiter=',')
        for row in data:
...
def insert_ppn(name, commissioning_year):
    try:
        data = csv.reader(open('/home/md/Téléchargements/ppnames.csv'),delimiter=',')
        for row in data:
